...
- For missing config, say: `전송하려면 BAI 계정 설정이 필요합니다. 처음 한 번만 python scripts/bai_feed_config.py를 실행하면 됩니다.`
...
- If config is missing, help the user create it with `python scripts/bai_feed_config.py`.
